...
object OutdoorSensor extends LazyLogging with DataStructures  {
  implicit val system: ActorSystem = ActorSystem("bme680_processor")
  implicit val materializer: ActorMaterializer = ActorMaterializer()
  implicit val executionContext: ExecutionContextExecutor = materializer.executionContext
  val log: Logger = Logger("bme680")
                    ...
                    case Some(data) =>
                      Http().singleRequest(HttpRequest(
                        ...
                        case Success(res) => res match {
                          ...
                          case _ => log.error("Influx failure: " + res + " -- record: " + data)
                        }
